...
class Preprocessing:
    ...
    def __init__(self, species_folder, lowpass_cutoff, 
        ...
        self.saved_data_path = self.species_folder + '/Saved_Data1/'
    ...
    def save_spec_data_to_pickle(self, X, Y):
        '''
    ...
    def load_spec_data_from_pickle(self):
        '''
        Load all of the spectrograms from a pickle file
        
        '''
        infile = open(os.path.join(self.saved_data_path, 'X-pow.pkl'),'rb')
        X = pickle.load(infile)
        infile.close()
        
        infile = open(os.path.join(self.saved_data_path, 'Y-pow.pkl'),'rb')
